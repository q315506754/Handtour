...
public class FuncUtil {
    ...
    public static CopierFieldConvertor<Long, String> long2StringConvertor = DateUtil::getDate_YYYY_MM_DD;
    ...
    public static Copier auditLong2StringCopier = Copier.to(Object.class).map("createTime", "createTime", long2StringConvertor).map("lastUpdateTime", "lastUpdateTime", long2StringConvertor).map("lastUpdateTime", "lastUpdateTimeTs");
